...
class MainTest {
    ...
    void convertToCsv() throws IOException, SAXException, ParserConfigurationException {
        ...
        String csv = Main.convertToCsv(kml);
    ...
    @Test
    void isPureAscii() {
        Assertions.assertTrue(Main.isPureAscii("abcdefghijklmnopqrstuvwxyz1234567890"));
        Assertions.assertFalse(Main.isPureAscii("ä"));
        Assertions.assertFalse(Main.isPureAscii("ö"));
        Assertions.assertFalse(Main.isPureAscii("ü"));
        Assertions.assertFalse(Main.isPureAscii("ß"));
    }
}