...
public class OfmConverterTests
{

    @Test
    public void convertToCsv() throws IOException, SAXException, ParserConfigurationException {
        ...
        String csv = OfmConverter.convertToOpenFireMapCsv(kml);

        String expectedCsv =
                "emergency;ref;longitude;latitude;fire_hydrant:type;fire_hydrant:pressure\n" +
                        "fire_hydrant;101;10.5361927;49.6234328;pillar;yes\n" +
                        "fire_hydrant;122;10.5361173;49.6231482;underground;yes";
